# Lembrar:
# Não está ocultando as linhas da PA para as abas 9 e 10
# Falta implementar ocultação das linhas da PA para as abas 2, 3 e 4
# Terminar de implementar a "Seleção dos Sistemas" da aba 11
...
#pasta_backup = 'Q:/GROUPS/BR_SC_JGS_WM_ENG_PRODUTOS/MS/INSTRUMENTAÇÃO/TABELAS INSTRUMENTOS PADRONIZADOS/01_Padronização - CDC_Instrumentação/PWQP 2022/Armazenamento'

pasta_backup = 'C:/Users/Carlos/Desktop/pasta_backup'
...
def compila_dados():
   ...
   dados_aba9 = {'opcoes91': opcoes91.get(), 'opcoes92': opcoes92.get(), 'opcoes95': opcoes95.get(), 'opcoes96': opcoes96.get(), 'opcoes97': opcoes97.get(), 'opcoes98': opcoes98.get(), 'lt91': lt91.get(), 'inc91': inc91.get()}
   ...
   if flag_botao == False:
      ...
      elif 'opcoes102' in dados_aba10 and dados_aba10['opcoes102'] == 'N/A':
         tagX_aba10 = 'N/A'
      ...
      # Imprime o campo TagX*  e Rele auxiliar da planilha
      if opcoes101 != 'Sem freio':
      ...
      # Ocultação das linhas não utilizadas =============================================================================================================================================
      # Linhas ocultadas por padrão
      try:
      ...
      try:
         ...
         # Refrigeração
         if aba_pa['D'+str(491)].value == '*' and aba_pa['D'+str(498)].value == '*' and aba_pa['D'+str(506)].value == '*' and aba_pa['D'+str(514)].value == '*':
            aba_pa.row_dimensions.group(489, 489, hidden=True)
            aba_pa.row_dimensions.group(504, 504, hidden=True)

         if aba_pa['D'+str(491)].value == '*':
            aba_pa.row_dimensions.group(490, 496, hidden=True)

         if aba_pa['D'+str(498)].value == '*':
            aba_pa.row_dimensions.group(497, 503, hidden=True)

         if aba_pa['D'+str(506)].value == '*':
            aba_pa.row_dimensions.group(505, 512, hidden=True)

         if aba_pa['D'+str(514)].value == '*':
            aba_pa.row_dimensions.group(513, 520, hidden=True)

         # Freio
         if aba_pa['D'+str(523)].value == '*':
            aba_pa.row_dimensions.group(521, 524, hidden=True)

      except:
         print('Erro ao tentar ocultar as linhas inutilizadas da planilha.')
         erro = True

      # Salva e fecha planilhas nas pastas ============================================================================================================================================
      # Salvando a planilha Excel na pasta de backup
      pa.save(pasta_backup + "/planilha_resposta_mat_" + texto12.get() + ".xlsx")

      # Salvando a planilha Excel na pasta escolhida pelo usuário
      pa.save(pasta_escolhida + "/planilha_resposta_mat_" + texto12.get() + ".xlsx")

      #Fechando a planilha resposta em excel
      pa.close()

      # Janela de aviso de sucesso na execução ========================================================================================================================================
...
# Início da criação da interface gráfica ==============================================================================================================================================
def escolha_idioma():
   global info_texto, btn_imprimir, \
      ...
      varcb111, varcb112, varcb113, varcb114, varcb115, varcb116, varcb117, varcb118, \
   ...
   if var.get() == 1:
      ...
      fr_termom.place(x=5, y=125, width=450, height=190)
      ...
      fr_lt91.place(x=5, y=315, width=300, height=120)
      ...
      def ativa_desativ_campos_freio(e):
         if opcoes101.get() == 'Sem freio':
            opt102.configure(state='disable')
            opcoes102.set('N/A')

            increm101.configure(state='disable')
            inc101.set('0')

            lt101.delete(0, END)
            lt101.insert(END, "0")
            lt101.configure(state='disable')
            
         else:
            opt102.configure(state='normal')
            opcoes102.set('Selecionar...')
            
            increm101.configure(state='normal')
            inc101.set('Selecionar...')

            lt101.configure(state='normal')
            lt101.delete(0, END)
      ...
      OptionMenu(fr_comp, opcoes101, *lista101, command=ativa_desativ_campos_freio).place(x=300, y=20)
      ...
      opcoes102 = StringVar()
      opcoes102.set('Selecionar...')
      opt102 = OptionMenu(fr_comp, opcoes102, *lista102)
      opt102.place(x=300, y=50)
      ...
      fr_lt101.place(x=460, y=5, width=300, height=120)
      ...
      inc101 = StringVar()
      inc101.set('Selecionar...')
      increm101 = OptionMenu(fr_lt101, inc101, *lis101)
      increm101.place(x=150, y=50)

      # Conteúdo da Aba 11 pt ==================================================================================================
      aba11 = Frame(nb)
      nb.add(aba11, text='Executar Programa')

      fr_sel_abas = LabelFrame(aba11, borderwidth=1, relief='solid', text='  Seleção dos Sistemas:  ')
      fr_sel_abas.place(x=5, y=5, width=450, height=200)

      Label(fr_sel_abas, text='Deixe marcadas somente as opções nas quais deseja imprimir dados na ').place(x=5, y=5)
      Label(fr_sel_abas, text='planilha resposta. A aba "Informações do Projeto" deve ser preenchida ').place(x=5, y=25)
      Label(fr_sel_abas, text='junto com as opções escolhidas.').place(x=5, y=45)

      varcb111 = IntVar()
      varcb111.set(1)
      cb111 = Checkbutton(fr_sel_abas, text='Carcaça/Estator', variable=varcb111, onvalue=1, offvalue=0)
      cb111.place(x=5, y= 75)

      varcb112 = IntVar()
      varcb112.set(1)
      cb112 = Checkbutton(fr_sel_abas, text='Mancal L.A.', variable=varcb112, onvalue=1, offvalue=0)
      cb112.place(x=5, y= 100)

      varcb113 = IntVar()
      varcb113.set(1)
      cb113 = Checkbutton(fr_sel_abas, text='Mancal L.N.A.', variable=varcb113, onvalue=1, offvalue=0)
      cb113.place(x=5, y= 125)

      varcb114 = IntVar()
      varcb114.set(1)
      cb114 = Checkbutton(fr_sel_abas, text='Cx. Acess. Pequena', variable=varcb114, onvalue=1, offvalue=0)
      cb114.place(x=5, y= 150)

      varcb115 = IntVar()
      varcb115.set(1)
      cb115 = Checkbutton(fr_sel_abas, text='Cx. Acess. Média', variable=varcb115, onvalue=1, offvalue=0)
      cb115.place(x=250, y= 75)

      varcb116 = IntVar()
      varcb116.set(1)
      cb116 = Checkbutton(fr_sel_abas, text='Cx. Acess. Grande', variable=varcb116, onvalue=1, offvalue=0)
      cb116.place(x=250, y= 100)

      varcb117 = IntVar()
      varcb117.set(1)
      cb117 = Checkbutton(fr_sel_abas, text='Refrigeração', variable=varcb117, onvalue=1, offvalue=0)
      cb117.place(x=250, y= 125)

      varcb118 = IntVar()
      varcb118.set(1)
      cb118 = Checkbutton(fr_sel_abas, text='Comp. Gerais/Avulsos', variable=varcb118, onvalue=1, offvalue=0)
      cb118.place(x=250, y= 150)
      ...
      fr_salvar.place(x=5, y=205, width=450, height=200)
      ...
      fr_infos_aba11.place(x=462, y=13, width=730, height=393)

      Label(fr_infos_aba11, text='Informações importantes:', font="-weight bold -size 13").place(x=5, y=15)
      Label(fr_infos_aba11, text='Esta é uma versão de testes, podendo ocorrer "bugs".', font= '20').place(x=10, y=60)
      Label(fr_infos_aba11, text='Caso ocorra erro, entre em contato conosco e reporte.', font= '20').place(x=10, y=85)
      Label(fr_infos_aba11, text='Contato: duartec@weg.net', font= '20').place(x=10, y=110)

      Label(fr_infos_aba11, text='Instruções básicas de uso:', font= '20').place(x=10, y=160)
      Label(fr_infos_aba11, text='1) Escolha o idioma desejado no quadro acima;', font= '20').place(x=10, y=190)
      Label(fr_infos_aba11, text='2) Percorra as abas preenchendo todos os dados;', font= '20').place(x=10, y=220)
      Label(fr_infos_aba11, text='3) Escolha uma pasta na aba "Executar Programa";', font= '20').place(x=10, y=250)
      Label(fr_infos_aba11, text='4) Clique no botão "Imprimir Planilha";', font= '20').place(x=10, y=280)
      Label(fr_infos_aba11, text='3) Acesse a pasta de salvamento escolhida;', font= '20').place(x=10, y=310)
      Label(fr_infos_aba11, text='3) Abra a planilha "planilha_resposta_mat_12345678.xlsx".', font= '20').place(x=10, y=340)
